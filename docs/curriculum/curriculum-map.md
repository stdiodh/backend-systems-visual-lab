...
- Next Question: 성능과 확장성을 고려하다 보면 RDB 외 저장소가 필요한지 판단해야 한다. NoSQL은 언제 고려해야 하는가?

### 부록 B. NoSQL 이해하기

- Category: `appendix-nosql`
- Detail Doc: [appendix-b-nosql.md](../sequences/appendix-b-nosql.md)
- Next Question: 분산 환경에서 공유 자원을 제어해야 할 때 DB 기반 분산 잠금을 어떻게 구현할 수 있는가?
...
- Next Question: 끝. 전체 랩의 운영/디자인 구현 단계로 돌아가 각 장을 Visual Lab으로 구현한다.
